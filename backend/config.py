...
AI_SYSTEM_PROMPT_VARIANTS = os.getenv("AI_SYSTEM_PROMPT_VARIANTS", "").strip()
AI_MAX_CONCURRENT = _get_int("AI_MAX_CONCURRENT", 4)
AI_QUEUE_TIMEOUT_SECONDS = _get_int("AI_QUEUE_TIMEOUT_SECONDS", 2)
AI_RATE_LIMIT_SECONDS = _get_int("AI_RATE_LIMIT_SECONDS", 0)
AI_ERROR_BUDGET_TARGET = _get_float("AI_ERROR_BUDGET_TARGET", 0.01)
AI_ALLOW_USERID_FALLBACK = _get_bool("AI_ALLOW_USERID_FALLBACK", True)
AI_RATE_LIMIT_REPLY = os.getenv(
    "AI_RATE_LIMIT_REPLY",
    "\u041f\u043e\u0434\u043e\u0436\u0434\u0438\u0442\u0435 \u043f\u0430\u0440\u0443 \u0441\u0435\u043a\u0443\u043d\u0434, \u044f \u043f\u0440\u043e\u0432\u0435\u0440\u044f\u044e.",
).strip()
AI_METRICS_PATH = os.getenv("AI_METRICS_PATH", "data/ai_metrics.json").strip()
AI_METRICS_MAX_EVENTS = _get_int("AI_METRICS_MAX_EVENTS", 200)
AI_MEMORY_BACKEND = os.getenv("AI_MEMORY_BACKEND", "file").strip().lower()
AI_MEMORY_DIR = os.getenv("AI_MEMORY_DIR", "data/chat_memory").strip()
AI_MEMORY_MAX_MESSAGES = _get_int("AI_MEMORY_MAX_MESSAGES", 200)
AI_MEMORY_MAX_FACTS = _get_int("AI_MEMORY_MAX_FACTS", 20)
